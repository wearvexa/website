    ...
    <section className={"px-5 mt-14 flex flex-col items-center gap-6"}>
      ...
      >
        ...
        <a
          href={"#"}
          className={
            "transition-all duration-200 active:scale-95 rounded-full hover:bg-black hover:text-white cursor-pointer size-12 border border-black flex justify-center items-center"
          }
        >
